...
mkdir build
cd build
cmake ../ -DCMAKE_BUILD_TYPE=Debug -DPAGMO_WITH_EIGEN3=ON -DPAGMO_WITH_IPOPT=ON -DPAGMO_WITH_NLOPT=ON -DCMAKE_PREFIX_PATH=$deps_dir -DCMAKE_INSTALL_PREFIX=$deps_dir
...
# Start ipcluster.
ipcluster start --debug --daemonize=True
sleep 20
